...
module.exports = function() {
  ...
  Client.prototype.request = function(method, options, body, cb) {
    ...
    const requestIdFromStore = this.getFromStore('requestId')
    if (requestIdFromStore) {
      reqParams.headers["x-request-id"] = requestIdFromStore
    }
    if(this.sessionId) {
  ...
  Client.prototype.getFromStore = function(property) {
  ...
  Client.prototype.setAsyncLocalStorage = function (asyncLocalStorage) {
